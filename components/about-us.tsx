...
export function AboutUs() {
  const values = [
    ...
    },
    {
      ...
      title: "Quality & Care",
      description:
        "We believe in products that last, reducing waste and providing exceptional value to our customers.",
    ...
    },
    {
      ...
      description:
        "Building a community of conscious consumers who care about the planet and future generations.",
    ...
    },
    {
      ...
      title: "Global Impact",
      description:
        "Working with suppliers worldwide who share our commitment to ethical and sustainable practices.",
  ...
  const timeline = [
    {
      ...
      title: "The Beginning",
      description:
        "Founded with a mission to make sustainable shopping accessible to everyone.",
    },
    {
      year: "2021",
      title: "First Milestone",
      description:
        "Reached 1,000 customers and launched our eco-friendly packaging initiative.",
    },
    {
      year: "2022",
      title: "Expansion",
      description:
        "Expanded our product range and partnered with 50+ sustainable brands worldwide.",
    },
    {
      year: "2023",
      title: "Carbon Neutral",
      description:
        "Achieved carbon neutrality across all operations and shipping processes.",
    },
    {
      year: "2024",
      title: "Community Growth",
      description:
        "Built a thriving community of 50,000+ eco-conscious customers.",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            ...
            affordable, and beautiful. Every product we curate tells a story of
            environmental responsibility and exceptional quality.
          </p>
        </motion.div>
          ...
          <Card className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white border-0 shadow-2xl">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-emerald-100 max-w-4xl mx-auto leading-relaxed">
                To revolutionize the way people shop by providing a curated
                marketplace of sustainable, high-quality products that don't
                compromise on style or functionality. We believe that conscious
                consumption can create a better world for future generations.
              </p>
            </CardContent>
          </Card>
        </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600 text-sm">
                    Every product is thoroughly vetted for quality, durability,
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-600 text-sm">
                    We promote products designed for longevity, repairability,
                    and recyclability.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-slate-600 text-sm">
                    We constantly evolve our practices to reduce environmental
          ...
          <Card className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white border-0 shadow-2xl">
            <CardContent className="p-12">
              ...
              <p className="text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
                Ready to make a positive impact? Explore our curated collection
                of sustainable products and join thousands of customers creating
                a better future.
              </p>
